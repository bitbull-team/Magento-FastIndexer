...
class SchumacherFM_FastIndexer_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function isTransactionDisabledForProductFlatReindex(){
    ...
    public function getProcessListToUpdateWithCron(){
        $list = Mage::getStoreConfig(self::XPATH_CONFIGURABLE_INDEXER_PROCESS_LIST);
